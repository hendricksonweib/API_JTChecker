...
export interface ApiAttendanceAttendance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    studen_status: Schema.Attribute.Enumeration<
      ['presente', 'ausente', 'justificado', 'esperando']
    >;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attendances: Schema.Attribute.Relation<
      ...
      'api::attendance.attendance'
    >;
    card_id: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imagem: Schema.Attribute.Media<'images' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::student.student'
